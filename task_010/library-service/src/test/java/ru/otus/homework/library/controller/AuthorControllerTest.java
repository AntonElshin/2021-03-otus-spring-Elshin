...
public class AuthorControllerTest {
    ...
    public void readAll() throws Exception {
        ...
        this.mockMvc.perform(get("/author/authors/all"))
                .andDo(print())
    ...
    public void findByLastName() throws Exception {
        ...
        this.mockMvc.perform(get("/author/authors?authorLastName=Пушкин"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Пушкин")))
                .andExpect(content().string(containsString("Александр")))
    ...
    public void findByFirstName() throws Exception {
        ...
        this.mockMvc.perform(get("/author/authors?authorFirstName=Александр"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Пушкин")))
                .andExpect(content().string(containsString("Александр")))
    ...
    public void findByMiddleName() throws Exception {
        ...
        this.mockMvc.perform(get("/author/authors?authorMiddleName=Сергеевич"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Пушкин")))
                .andExpect(content().string(containsString("Александр")))
    ...
    public void findByLastNameAndFirstNameAndMiddleName() throws Exception {
        ...
        this.mockMvc.perform(get("/author/authors?authorLastName=Пушкин&authorFirstName=Александр&authorMiddleName=Сергеевич"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Пушкин")))
                .andExpect(content().string(containsString("Александр")))
    ...
    public void read() throws Exception {
        ...
        this.mockMvc.perform(get("/author/authors/" + 1))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Дойл")))
                .andExpect(content().string(containsString("Артур")))
    ...
    public void create() throws Exception {
        ...
        AuthorReqDTO authorReqDTO = createAuthorReqDTO("Елшин", "Антон", "Николаевич");

        String json = new ObjectMapper().writeValueAsString(authorReqDTO);

        mockMvc.perform(post("/author/authors").contentType(MediaType.APPLICATION_JSON).content(json))
                .andExpect(status().isOk());
    ...
    public void update() throws Exception {
        ...
        AuthorReqDTO updateAuthorReqDTO = createAuthorReqDTO("Елшин 1", "Антон 1", "Николаевич 1");

        String json = new ObjectMapper().writeValueAsString(updateAuthorReqDTO);

        this.mockMvc.perform(put("/author/authors/" + authorResDTO.getId()).contentType(MediaType.APPLICATION_JSON).content(json))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    public void delete() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete("/author/authors/" + authorResDTO.getId()))
                .andDo(print());
