...
import ru.otus.homework.library.mapper.BookCommentMapper;
import ru.otus.homework.library.repository.BookCommentRepository;
...
public class BookCommentServiceImplTest {
    ...
    private BookCommentResDTO createBookCommentResDTO(Long id, String text) {
        BookCommentResDTO bookCommentResDTO = new BookCommentResDTO();
        bookCommentResDTO.setId(id);
        bookCommentResDTO.setText(text);
        return bookCommentResDTO;
    }

    private BookCommentResListDTO createBookCommentResListDTO(Long id, String text) {
        BookCommentResListDTO bookCommentResListDTO = new BookCommentResListDTO();
        bookCommentResListDTO.setId(id);
        bookCommentResListDTO.setText(text);
        return bookCommentResListDTO;
    }
    ...
    void addBookComment() {
        ...
        BookCommentReqDTO bookCommentReqDTO = createBookCommentReqDTO(createBookReqIdDTO(1L), "Комментарий");
        BookCommentResDTO bookCommentResDTO = createBookCommentResDTO(1L, "Комментарий");
    ...
    void updateBookCommentWithNewBookAndNewText() {
        ...
        BookCommentReqDTO bookCommentReqDTO = createBookCommentReqDTO(createBookReqIdDTO(2L), "Комментарий!!!");
        BookCommentResDTO bookCommentResDTO = createBookCommentResDTO(2L, "Комментарий!!!");
    ...
    void findAllByBookId() {
        ...
        BookCommentResListDTO bookCommentResListDTO = createBookCommentResListDTO(1L, "Комментарий");
