...
public class BookServiceImplTest {
    ...
    void addBookWithIsbnCheck() {
        ...
        given(bookRepositoryJpa.findByParamsEqualsIgnoreCase(null, "123", null, null)).willReturn(new ArrayList<>());
        given(authorRepositoryJpa.findByIds(List.of(1L))).willReturn(authors);
        given(genreRepositoryJpa.findByIds(List.of(1L))).willReturn(genres);
        given(bookRepositoryJpa.save(book)).willReturn(createdBook);

        bookService.add("Название", "123", "Описание", "1", "1");

        Mockito.verify(bookRepositoryJpa, Mockito.times(1)).findByParamsEqualsIgnoreCase(null, "123", null, null);
        Mockito.verify(authorRepositoryJpa, Mockito.times(1)).findByIds(List.of(1L));
        Mockito.verify(genreRepositoryJpa, Mockito.times(1)).findByIds(List.of(1L));
    ...
    void addBookWithoutIsbnCheckNullIsbn() {
        ...
        Mockito.verify(bookRepositoryJpa, Mockito.times(0)).findByParamsEqualsIgnoreCase(null, null, null, null);
        Mockito.verify(authorRepositoryJpa, Mockito.times(1)).findByIds(List.of(1L));
        Mockito.verify(genreRepositoryJpa, Mockito.times(1)).findByIds(List.of(1L));
        Mockito.verify(bookRepositoryJpa, Mockito.times(1)).save(book);
    ...
    void addBookWithoutIsbnCheckEmptyIsbn() {
        ...
        given(authorRepositoryJpa.findByIds(List.of(1L))).willReturn(authors);
        given(genreRepositoryJpa.findByIds(List.of(1L))).willReturn(genres);
        given(bookRepositoryJpa.save(book)).willReturn(book);

        bookService.add("Название", "", "Описание", "1", "1");

        Mockito.verify(bookRepositoryJpa, Mockito.times(0)).findByParamsEqualsIgnoreCase(null, "", null, null);
        Mockito.verify(authorRepositoryJpa, Mockito.times(1)).findByIds(List.of(1L));
        Mockito.verify(genreRepositoryJpa, Mockito.times(1)).findByIds(List.of(1L));
        Mockito.verify(bookRepositoryJpa, Mockito.times(1)).save(book);
    ...
    void addBookNotUniqueIsbnError() {
        ...
        given(bookRepositoryJpa.findByParamsEqualsIgnoreCase(null, "123", null, null)).willReturn(books);
    ...
    void addBookNotInvalidAuthors() {
        ...
        given(bookRepositoryJpa.findByParamsEqualsIgnoreCase(null, "123", null, null)).willReturn(new ArrayList<>());
        given(authorRepositoryJpa.findByIds(List.of(3L))).willReturn(null);
    ...
    void addBookNotInvalidGenres() {
        ...
        given(bookRepositoryJpa.findByParamsEqualsIgnoreCase(null, "123", null, null)).willReturn(new ArrayList<>());
        given(authorRepositoryJpa.findByIds(List.of(1L))).willReturn(authors);
        given(genreRepositoryJpa.findByIds(List.of(3L))).willReturn(null);
    ...
    void updateBookWithoutIsbnCheck() {
        ...
        Mockito.verify(bookRepositoryJpa, Mockito.times(0)).findByParamsEqualsIgnoreCase(null, "123", null, null);
        Mockito.verify(authorRepositoryJpa, Mockito.times(1)).findByIds(List.of(1L));
        Mockito.verify(genreRepositoryJpa, Mockito.times(1)).findByIds(List.of(1L));
        Mockito.verify(bookRepositoryJpa, Mockito.times(1)).save(book);
    ...
    void updateBookWithIsbnCheck() {
        ...
        given(bookRepositoryJpa.findById(1L)).willReturn(Optional.of(foundBook));
        given(bookRepositoryJpa.findByParamsEqualsIgnoreCase(null, "1234", null, null)).willReturn(new ArrayList<>());
        given(authorRepositoryJpa.findByIds(List.of(1L))).willReturn(authors);
        given(genreRepositoryJpa.findByIds(List.of(1L))).willReturn(genres);
        given(bookRepositoryJpa.save(updateBook)).willReturn(updateBook);

        bookService.update(1L, "Название", "1234", "Описание", "1", "1");

        Mockito.verify(bookRepositoryJpa, Mockito.times(1)).findByParamsEqualsIgnoreCase(null, "1234", null, null);
        Mockito.verify(authorRepositoryJpa, Mockito.times(1)).findByIds(List.of(1L));
        Mockito.verify(genreRepositoryJpa, Mockito.times(1)).findByIds(List.of(1L));
        Mockito.verify(bookRepositoryJpa, Mockito.times(1)).save(updateBook);
    ...
    void updateBookNotUniqueNameError() {
        ...
        given(bookRepositoryJpa.findById(1L)).willReturn(Optional.of(foundBook));
        given(bookRepositoryJpa.findByParamsEqualsIgnoreCase(null, "1234", null, null)).willReturn(List.of(foundBook));
    ...
    void updateBookNotInvalidAuthors() {
        ...
        given(bookRepositoryJpa.findById(1L)).willReturn(Optional.of(book));
        given(authorRepositoryJpa.findByIds(List.of(2L))).willReturn(null);
    ...
    void updateBookNotInvalidGenres() {
        ...
        given(bookRepositoryJpa.findById(1L)).willReturn(Optional.of(book));
        given(authorRepositoryJpa.findByIds(List.of(1L))).willReturn(authors);
        given(genreRepositoryJpa.findByIds(List.of(2L))).willReturn(null);
    ...
    void processLinks() {
        ...
        given(authorRepositoryJpa.findByIds(List.of(1L, 2L))).willReturn(authors);
        given(genreRepositoryJpa.findByIds(List.of(1L, 2L))).willReturn(genres);
    ...
    void processLinksInvalidAuthors() {
        ...
        given(authorRepositoryJpa.findByIds(List.of(1L))).willReturn(null);
    ...
    void processLinksInvalidGenres() {
        ...
        given(genreRepositoryJpa.findByIds(List.of(1L))).willReturn(null);
