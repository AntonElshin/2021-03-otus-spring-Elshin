...
public class BookRepositoryJpaTest {
    ...
    void shouldReturnExpectedBookCount() {
        Long actualBooksCount = bookRepositoryJpa.count();
    ...
    void shouldFindAllBooksLike() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsLikeIgnoreCase(null, null, null, null);
    ...
    void shouldFindAllBooksLikePartTitle() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsLikeIgnoreCase("ы", null, null, null);
    ...
    void shouldFindAllBooksLikePartIsbn() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsLikeIgnoreCase(null, "353", null, null);
    ...
    void shouldFindAllBooksLikeAuthorId() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsLikeIgnoreCase(null, null, 3L, null);
    ...
    void shouldFindAllBooksLikeGenreId() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsLikeIgnoreCase(null, null, null, 3L);
    ...
    void shouldFindAllBooksLikePartTitleAndIsbn() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsLikeIgnoreCase("ы", "353", null, null);
    ...
    void shouldFindAllBooksLikePartTitleAndIsbnAndAuthorId() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsLikeIgnoreCase("ы", "353", 3L, null);
    ...
    void shouldFindAllBooksLikePartTitleAndIsbnAndAuthorIdAndGenreId() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsLikeIgnoreCase("ы", "353", 3L, 3L);
    ...
    void shouldFindAllBooksEquals() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsEqualsIgnoreCase(null, null, null, null);
    ...
    void shouldFindAllBooksEqualsTitle() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsEqualsIgnoreCase("Сказка о рыбаке и рыбке", null, null, null);
    ...
    void shouldFindAllBooksEqualsIsbn() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsEqualsIgnoreCase(null, "978-5-353-08602-4", null, null);
    ...
    void shouldFindAllBooksEqualsAuthorId() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsEqualsIgnoreCase(null, null, 3L, null);
    ...
    void shouldFindAllBooksEqualsGenreId() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsEqualsIgnoreCase(null, null, null, 3L);
    ...
    void shouldFindAllBooksEqualsTitleAndIsbn() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsEqualsIgnoreCase("Сказка о рыбаке и рыбке", "978-5-353-08602-4", null, null);
    ...
    void shouldFindAllBooksEqualsTitleAndIsbnAndAuthorId() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsEqualsIgnoreCase("Сказка о рыбаке и рыбке", "978-5-353-08602-4", 3L, null);
    ...
    void shouldFindAllBooksEqualsTitleAndIsbnAndAuthorIdAndGenreId() {
        ...
        List<Book> books = bookRepositoryJpa.findByParamsEqualsIgnoreCase("СКАЗКА о рыбаке и рыбке", "978-5-353-08602-4", 3L, 3L);
