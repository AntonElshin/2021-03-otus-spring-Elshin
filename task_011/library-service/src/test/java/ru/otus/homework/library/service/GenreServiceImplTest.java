...
import ru.otus.homework.library.mapper.GenreMapperImpl;
...
public class GenreServiceImplTest {
    ...
    private GenreResDTO createGenreResDTO(Long id, String name, String description) {
        GenreResDTO genreResDTO = new GenreResDTO();
        genreResDTO.setId(id);
        genreResDTO.setName(name);
        genreResDTO.setDescription(description);
        return genreResDTO;
    }
    ...
    void addGenre() {
        ...
        GenreResDTO genreResDTO = createGenreResDTO(1L, "Жанр", "Описание");
    ...
    void updateGenreWithNameCheck() {
        ...
        GenreReqDTO genreReqDTO = createGenreReqDTO("Жанр 1", "Описание");
        GenreResDTO genreResDTO = createGenreResDTO(1L, "Жанр 1", "Описание");
