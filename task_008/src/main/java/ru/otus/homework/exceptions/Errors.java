...
public enum Errors {
    ...
    MISSING_REQUIRED_PARAM_COMMENT_TEXT(21, "Missing required param comment text"),
    MISSING_REQUIRED_PARAM_COMMENT_ID(22, "Missing required param comment id"),
    BOOK_COMMENT_NOT_FOUND_BY_ID(8, "Book comment not found by id: %s")
    ;
