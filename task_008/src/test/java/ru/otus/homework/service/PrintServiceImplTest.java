...
public class PrintServiceImplTest {
    ...
    void printGenresCount() {
        ...
        String str = printService.printGenresCount(0L);
    ...
    void printAuthorsCount() {
        ...
        String str = printService.printAuthorsCount(0L);
    ...
    void printBooks() {
        ...
        BookComment bookComment_1 = new BookComment(1L, book_1, "Комментарий 1");
        BookComment bookComment_2 = new BookComment(2L, book_1, "Комментарий 2");
        BookComment bookComment_3 = new BookComment(3L, book_2, "Комментарий 3");
        BookComment bookComment_4 = new BookComment(4L, book_2, "Комментарий 4");

        book_1.setComments(List.of(bookComment_1, bookComment_2));
    ...
    void printBooksCount() {
        ...
        String str = printService.printBooksCount(0L);
    ...
    void printBookComment() {
        ...
        String str = printService.printBookComment(bookComment);
    ...
    void printBookComments() {
        ...
        String str = printService.printBookComments(List.of(bookComment_1, bookComment_2));
    ...
    void printBookCommentsCount() {
        ...
        String str = printService.printBookCommentsCount(0L);
